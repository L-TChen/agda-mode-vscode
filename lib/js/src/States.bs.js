...
function Impl(Editor) {
  ...
  var destroyAll = function (param) {
    return Belt_Array.forEach(Js_dict.entries(dict), (function (param) {
                  Curry._1(State.destroy, param[1]);
...
function Impl$1(Editor) {
  ...
  var CommandHandler = State__Command$AgdaModeVscode.Impl(Editor);
                  ...
                  return Curry._2(Editor.addToSubscriptions, Curry._2(Editor.registerCommand, name, (function (editor) {
                                    ...
                                    if (typeof command === "number" && command === 0) {
                                      Belt_Option.forEach(Curry._1(Editor.getFileName, editor), (function (fileName) {
                                              ...
                                              Curry._2(Editor.addToSubscriptions, Curry._2(Editor.View.on, state.view, (function (_event) {
                                                          
                                                        })), context);
                                              Curry._2(Editor.addToSubscriptions, Curry._1(Editor.Disposable.make, Curry._1(state.inputMethod.onAction.on, (function (_action) {
                                    ...
                                    return Belt_Option.forEach(getByEditor(editor), (function (state) {
                                                  Curry._2(CommandHandler.handle, state, command);
