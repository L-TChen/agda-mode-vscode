...
function Impl(Editor) {
  ...
  var handle = function (_indices) {
    if (typeof _indices === "number") {
      switch (_indices) {
        case /* UpdateRange */0 :
      ...
      switch (_indices.tag | 0) {
            ...
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      ...
                      /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                                  var innerRange = Curry._2(Task.Goal.getInnerRange, goal, state.editor);
                                  ...
                                  return $$Promise.map(Curry._3(Editor.setText, state.editor, outerRange, content), (function (param) {
                                                if (param) {
                                                  Curry._1(Task.Goal.destroy, goal);
                                                  return /* [] */0;
                                                } else {
                                                  return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                            Curry._2(Task.displayError, "Goal-related Error", "Unable to remove the boundary of goal #" + String(goal.index)),
                                                            /* [] */0
                                                          ]);
                                                }
                                              }));
        ...
        case /* ReplaceWithLines */4 :
            var lines = _indices[1];
            var goal$1 = _indices[0];
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                              var match = indentationWidth(goal$1, state.editor);
                              ...
                              console.log("=================");
                              var start = Curry._2(Editor.pointAtOffset, state.editor, goal$1.range[0]);
                              ...
                              var end_ = Curry._2(Editor.pointAtOffset, state.editor, goal$1.range[1]);
                              ...
                              return $$Promise.map(Curry._3(Editor.setText, state.editor, rangeToBeReplaced, indentedLines), (function (param) {
                                            if (param) {
                                              ...
                                              return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                                                        Curry._2(Task.displayError, "Goal-related Error", "Unable to replace the lines of goal #" + String(goal$1.index)),
                                                        /* [] */0
                                                      ]);
                                            }
                                          }));
        ...
        case /* ReplaceWithLambda */5 :
            var lines$1 = _indices[1];
            var goal$2 = _indices[0];
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
                              var goalEnd = Curry._2(Editor.pointAtOffset, state.editor, goal$2.range[1]);
        ...
        case /* LocalOrGlobal */6 :
            var $$global = _indices[1];
            var local = _indices[0];
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 6, [/* UpdateRange */0]),
                      /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
        ...
        case /* LocalOrGlobal2 */7 :
            var $$global$1 = _indices[2];
            var localEmpty = _indices[1];
            var local$1 = _indices[0];
            return /* :: */Caml_chrome_debugger.simpleVariant("::", [
                      /* Goal */Caml_chrome_debugger.variant("Goal", 6, [/* UpdateRange */0]),
                      /* :: */Caml_chrome_debugger.simpleVariant("::", [
                          /* WithStateP */Caml_chrome_debugger.variant("WithStateP", 8, [(function (state) {
